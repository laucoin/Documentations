      ...
      "/atlas/": [
        ...
        },
        {
          ...
          items: [
            ...
            { text: "Getting Started", link: "/atlas/technical/getting-started" },
            { text: "Architecture", link: "/atlas/technical/architecture" },
            { text: "Bootstrap Orchestration", link: "/atlas/technical/bootstrap" },
            {
              text: "ADRs",
              collapsed: false,
              items: [
                { text: "Index", link: "/atlas/technical/adr/" },
                { text: "001 — Kubernetes vs Docker", link: "/atlas/technical/adr/001-kubernetes-vs-docker" },
                { text: "002 — Talos vs k3s/Debian", link: "/atlas/technical/adr/002-talos-vs-k3s-debian" },
                { text: "003 — OpenTofu vs Terraform vs Pulumi", link: "/atlas/technical/adr/003-opentofu-vs-terraform-vs-pulumi" },
                { text: "004 — Argo CD vs Flux", link: "/atlas/technical/adr/004-argocd-vs-flux" },
                { text: "005 — Traefik", link: "/atlas/technical/adr/005-traefik-ingress" },
                { text: "006 — cert-manager", link: "/atlas/technical/adr/006-cert-manager-tls" },
                { text: "007 — local-path + Restic", link: "/atlas/technical/adr/007-local-path-restic-storage" },
                { text: "008 — Authentik", link: "/atlas/technical/adr/008-authentik-oidc" },
                { text: "009 — Infisical", link: "/atlas/technical/adr/009-infisical-secrets" },
                { text: "010 — Harbor", link: "/atlas/technical/adr/010-harbor-registry" },
                { text: "011 — Prometheus + Loki", link: "/atlas/technical/adr/011-prometheus-loki-observability" },
                { text: "012 — OpenTofu owns L3 handshake", link: "/atlas/technical/adr/012-opentofu-owns-identity-secret-bootstrap" },
              ],
            },
          ],
        },
