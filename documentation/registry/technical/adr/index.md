...
| [010](/registry/technical/adr/010-scheduled-retention-purges)          | Retention purges as scheduled, permission-gated endpoints | Data retention | <Badge type="tip" text="Accepted" /> |
| [011](/registry/technical/adr/011-primeng-runtime-theming)             | PrimeNG with runtime theming | Frontend UI | <Badge type="tip" text="Accepted" /> |
| [012](/registry/technical/adr/012-per-instance-rate-limit-caffeine)    | Per-instance authentication rate limiting with Caffeine, not a shared store | Security | <Badge type="tip" text="Accepted" /> |
